...
public class NoRandomEnvironmentDescription extends AbsTestEnvironmentDescription {
...
//        add(new Purpose());
    ...
    public NoRandomEnvironmentDescription() {
    	initEnv();
...
//		System.out.println(Math.PI / (Math.PI/2) == 2 );
		final NoRandomEnvironmentDescription myEnv1 = new NoRandomEnvironmentDescription();
...
//		frame.add(menu);
		...
		final NoRandomEnvironmentDescription myEnv = new NoRandomEnvironmentDescription();
